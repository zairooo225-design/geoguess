export const audioFiles = {
  ...
  fanfare: 'https://cdn.pixabay.com/download/audio/2021/08/04/audio_bb630cc098.mp3?filename=fanfare-4626.mp3',
  podium_pop: 'https://cdn.pixabay.com/download/audio/2022/03/15/audio_73da3fb06a.mp3?filename=pop-up-39239.mp3',
...
class AudioManager {
  ...
  constructor() {
    if (typeof window !== 'undefined') {
      this.sfxAudios.click = new Audio(audioFiles.click);
      this.sfxAudios.error = new Audio(audioFiles.error);
      this.sfxAudios.success = new Audio(audioFiles.success);
      this.sfxAudios.keypress = new Audio(audioFiles.keypress);
      this.sfxAudios.fanfare = new Audio(audioFiles.fanfare);
      this.sfxAudios.podium_pop = new Audio(audioFiles.podium_pop);
      this.sfxAudios.chinese_meme = new Audio(audioFiles.chinese_meme);
  ...
  tryResume() {
    this.initAudioContext();
    if (this.bgmAudio && this.bgmAudio.paused && this.bgmAudio.volume > 0) {
      this.bgmAudio.play().catch(() => {});
    }
  }
